...
$stmt = $pdo->prepare('SELECT COUNT(CarId) as NbVoiture FROM cars');
$stmt->execute();
$NbVoiture = $stmt->fetchColumn();

$stmt2 = $pdo->prepare('SELECT COUNT(ResID) as NbReservation FROM reservations');
$stmt2->execute();
$NbReservation = $stmt2->fetchColumn();

$stmt3 = $pdo->prepare('SELECT COUNT(BrandId) as NbBrands FROM brands');
$stmt3->execute();
$NbBrands = $stmt3->fetchColumn()
?>
<main class="content">
  <div class="py-4">
      <div class="dropdown">
                  ...
                  <div class="row d-block d-xl-flex align-items-center">
                      <div class="col-12 col-xl-5 text-xl-center mb-3 mb-xl-0 d-flex align-items-center justify-content-xl-center">
                          ...
                          <div class="d-sm-none">
                              ...
                              <h3 class="fw-extrabold mb-1"><?php echo $NbVoiture ?></h3>
                          </div>
                      </div>
                      <div class="col-12 col-xl-7 px-xl-0">
                          <div class="d-none d-sm-block">
                              <h2 class="h6 text-gray-400 mb-0">Total Voitures</h2>
                              <h3 class="fw-extrabold mb-2"><?php echo $NbVoiture ?></h3>
                          </div>
                  ...
                  <div class="row d-block d-xl-flex align-items-center">
                      <div class="col-12 col-xl-5 text-xl-center mb-3 mb-xl-0 d-flex align-items-center justify-content-xl-center">
                          ...
                          <div class="d-sm-none">
                              ...
                              <h3 class="mb-1"><?php echo $NbReservation ?></h3>
                          </div>
                      </div>
                      <div class="col-12 col-xl-7 px-xl-0">
                          <div class="d-none d-sm-block">
                              <h2 class="h6 text-gray-400 mb-0">Total Reservation</h2>
                              <h3 class="fw-extrabold mb-2"><?php echo $NbReservation ?></h3>
                          </div>
                      </div>
                  </div>
              </div>
                  ...
                  <div class="row d-block d-xl-flex align-items-center">
                      <div class="col-12 col-xl-5 text-xl-center mb-3 mb-xl-0 d-flex align-items-center justify-content-xl-center">
                          ...
                          <div class="d-sm-none">
                              ...
                              <h3 class="mb-1"><?php echo $NbBrands ?></h3>
                          </div>
                      </div>
                      <div class="col-12 col-xl-7 px-xl-0">
                          <div class="d-none d-sm-block">
                              <h2 class="h6 text-gray-400 mb-0">Total Brands</h2>
                              <h3 class="fw-extrabold mb-2"><?php echo $NbBrands ?></h3>
                          </div>
                      </div>
                  </div>
              </div>
